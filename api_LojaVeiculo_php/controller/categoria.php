...
function post($dados_categoria){
    ...
    $categoria->ano_icone    = $dados_categoria->ano_icone;
    $categoria->data_cadastro       = $dados_categoria->data_cadastro;
    $categoria->data_alteracao               = $dados_categoria->data_alteracao;
...
function delete($registro){
    ...
    $viewCategoria->deleteVeiculo($result, $erro);
